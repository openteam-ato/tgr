    ...
    scale: function( options ) {
        ...
        Utils.wait({
            ...
            success: function() {
                ...
                var original_src = self.image.src,
                    new_size = self.width + '-' + self.height + '/',
                    insert_position = self.image.src.lastIndexOf('/') + 1;

                self.image.src = [original_src.slice(0, insert_position), new_size, original_src.slice(insert_position)].join('');
